 ...
 */
function getAccessControlPolicies() {
    return [
        {
            id: 'check-header',
            name: 'Check Header',
 ...
 */
function getTransformationPolicies() {
    return [
        {
            id: 'set-header',
            name: 'Set Header',
 ...
 */
function getObservabilityPolicies() {
    return [
        {
            id: 'log-to-eventhub',
...
//# sourceMappingURL=policy-catalog.js.map