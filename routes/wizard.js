...
router.get('/', async (req, res) => {
    try {
        ...
        // Debug logging
        console.log(`[Wizard Route] Rendering node: ${currentNode.id}`);
        console.log(`[Wizard Route] Node question: ${currentNode.question || '(empty)'}`);
        console.log(`[Wizard Route] Options count: ${options.length}`);
